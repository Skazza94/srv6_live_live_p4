...
{
    NS_LOG_INFO("newval: " + std::to_string(newval));
...
main(int argc, char* argv[])
{
    ...
    std::string file_name = get_path(resultsPath, "llreceiver-cwnd.data");
    //        Simulator::Schedule(Seconds(1),
    //                            &TraceCwnd,
    //                            file_name,
    //                            llReceivers.Get(0)->GetId());

    file_name = get_path(resultsPath, "llsender-cwnd.data");
    Simulator::Schedule(Seconds(2), &TraceCwnd, file_name, llSenders.Get(0)->GetId());
