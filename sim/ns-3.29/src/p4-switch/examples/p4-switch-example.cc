...
main (int argc, char *argv[])
{
  ...
  p4switch.SetDeviceAttribute("PipelineJson", StringValue("/ns3/ns-3-allinone/ns-3.29/src/p4-switch/examples/livelive_build/srv6_livelive.json"));
  p4switch.SetDeviceAttribute("PipelineCommands", StringValue("table_add srv6_function srv6_ll_deduplicate 85 => "));
